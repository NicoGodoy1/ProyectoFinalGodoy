      ...
      <div className=" detailcard tarjeta FlexContainer">
        ...
        <div className="card mb-2 justify-content-center align-items-center d-flex justify-content-center" >
          <div className="card-body f-6 m-1 p-1 d-flex align-items-center justify-content-center">
            ...
            <li className="list-group-item text-center fs-4 fw-bold my-4">{data.email}</li>
            ...
            <h6 className="text-center fs-2 text-success fw-bold">$2600</h6>
            <button className="btn-morado align-items-center mx-2 my-2" type="button" >
              Comprar <i className='fs-4 ms-2 m-2'> <BsCart3 /> </i>
            </button>
            </ul>
          </div>
        </div>
